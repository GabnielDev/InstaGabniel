                ...
                .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            hashMap.put("bio", "");
                            hashMap.put("imageurl","https://firebasestorage.googleapis.com/v0/b/instagabniel.appspot.com/o/placeholder.png?alt=media&token=9b7e9234-8d79-402a-be9a-9fa97add854e");
